...
function aicomplete
  ...
  set _output (ai -n --history  --system "$_system_prompt" "Return the most likely completion for the following partial input, which was already written by the user: $_input")
